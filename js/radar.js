(function(Raphael, impress) {
    ...
    drawCard('Go Language', cardTypes.language, 680, 550);
    ...
    var spdyCardElem = drawCard('SPDY', cardTypes.platform, 200, 560),
        spdyStepId = 'radar-spdy';
    document.querySelector('#radar-spdy')
        .addEventListener('impress:stepenter', function() {
            highlightCard(spdyCardElem, spdyStepId);
        });
    impress().init();
